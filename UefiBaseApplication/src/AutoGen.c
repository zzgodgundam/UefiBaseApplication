...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = { 0x1253D572, 0x9309, 0x4CE5, { 0x97, 0x10, 0x0C, 0x1B, 0xB2, 0xFF, 0xF3, 0xA5 } };

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UefiBaseApplication";
